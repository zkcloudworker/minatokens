...
import type { Field, ZkProgram } from "o1js_v1";

export async function deployToken_v1(params: {
  ...
  try {
    ...
    logItem({
      id: "compile tiny",
      status: "waiting",
      title: "Compiling ZkProgram",
      description: "Compiling ZkProgram...",
      date: new Date(),
    });
    ...
    updateLogItem("compile tiny", {
      status: "success",
      title: "ZkProgram compiled",
      description: `ZkProgram compiled in ${Math.floor(
    ...
    logItem({
      id: "prove tiny",
      status: "waiting",
      title: "Proving ZkProgram",
      description: "Proving ZkProgram...",
      date: new Date(),
    });
    console.time("prove tiny");
    const proveTimeTiny = Date.now();
    const proof = await program1.foo(Field(1), Field(1));
    console.timeEnd("prove tiny");
    updateLogItem("prove tiny", {
      status: "success",
      title: "ZkProgram proved",
      description: `ZkProgram proved in ${Math.floor(
